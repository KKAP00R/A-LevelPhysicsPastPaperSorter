...
def browsefn():
    ...
    Label(window2, text='Enter the Type of Paper (1 for Core and 2 for Extended)').grid(row=0)
...
def savefn():
    ...
    if s3 == '13':
        ...
        print("ERROR IN PAPER TYPE - NO. of QUESTIONS")
...
def fn15():
    ...
    save = Button(window3, text="SAVE + QUIT", width=20, command=savedata15)
    save.grid(row=16, column=1)
    Label(window3, text="Note: 1. When entering multiple topics").grid(row=17, column=0)
    Label(window3, text="seperate both with a space").grid(row=18, column=0)
    Label(window3, text="2. When entering the PDF baginning page").grid(row=19, column=0)
    Label(window3, text="Enter the page at the top, but subtract 1 from it").grid(row=20, column=0)
    Label(window3, text="So, if the page number at top is 2").grid(row=21, column=0)
    Label(window3, text="enter the beginning page as 1").grid(row=22, column=0)
...
def fn14():
    ...
    p14 = Entry(window3)
    p14.grid(row=14, column=3)
    save = Button(window3, text="SAVE + QUIT", width=20, command=savedata14)
    save.grid(row=15, column=1)
    Label(window3, text="Note: 1. When entering multiple topics").grid(row=16, column=0)
    Label(window3, text="seperate both with a space").grid(row=17, column=0)
    Label(window3, text="2. When entering the PDF baginning page").grid(row=18, column=0)
    Label(window3, text="Enter the page at the top, but subtract 1 from it").grid(row=19, column=0)
    Label(window3, text="So, if the page number at top is 2").grid(row=20, column=0)
    Label(window3, text="enter the beginning page as 1").grid(row=21, column=0)
...
def fn13():
    ...
    p13 = Entry(window3)
    p13.grid(row=13, column=3)
    save = Button(window3, text="SAVE + QUIT", width=20, command=savedata13)
    save.grid(row=14, column=1)
    Label(window3, text="Note: 1. When entering multiple topics").grid(row=15, column=0)
    Label(window3, text="seperate both with a space").grid(row=16, column=0)
    Label(window3, text="2. When entering the PDF baginning page").grid(row=17, column=0)
    Label(window3, text="Enter the page at the top, but subtract 1 from it").grid(row=18, column=0)
    Label(window3, text="So, if the page number at top is 2").grid(row=19, column=0)
    Label(window3, text="enter the beginning page as 1").grid(row=20, column=0)
...
def fn12():
    ...
    Label(window3, text="seperate both with a space").grid(row=15, column=0)
    Label(window3, text="2. When entering the PDF baginning page").grid(row=16, column=0)
...
def choice():
    ...
    Label(window5, text="ENTER 1 for Core and 2 for Extended").grid(row=1)
...
browse = Button(window1, text="LOAD", width=40, command=browsefn)
browse.pack()
access = Button(window1, text="ACCESS", width=40, command=choice)
access.pack()
escape = Button(window1, text="EXIT", width=20, command=window1.destroy)
escape.pack()
window1.mainloop()